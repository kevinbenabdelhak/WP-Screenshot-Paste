...
Rendez-vous sur la page du plugin sur https://kevin-benabdelhak.fr/plugins/wp-screenshot-paste/ et téléchargez le fichier ZIP.

Uploader le plugin sur votre site WordPress :
...
Rendez-vous sur un article ou une page (classique) ou dans votre médiathèque
...
* Ajout d'une case à cocher pour désactiver la génération automatique de la description d'image avec l'IA
